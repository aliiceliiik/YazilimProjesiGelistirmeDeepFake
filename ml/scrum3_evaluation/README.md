...
Daha yüksek doğruluk — %0.78 daha iyi accuracy (15 daha az hata)
Daha düşük FNR — Deepfake'i kaçırma oranı %1.57 (Xception: %2.19)
Hız kriteri rahatça geçildi — 20 ms ≪ 2 sn (kriterden 99× hızlı)
Deepfake tespitinde doğruluk kritik — False Negative (kaçırılan Deepfake) en kötü hata türü
...
Detaylar için: `model_card.md`
📥 Model Dosyaları
Eğitilmiş model dosyaları (`.keras` format) projenin GitHub Release bölümünden indirilebilir.
